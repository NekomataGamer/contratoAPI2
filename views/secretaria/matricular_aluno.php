                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-1">
                                <label for="exampleInputEmail1">DDD </label>
                                <input type="text" class="form-control" id="cep" name="pai_ddd_celular">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="exampleInputPassword1">Tel. Celular</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" name="pai_tel_celular">
                            </div>
                            <div class="form-group col-md-5">
                                <label for="exampleInputPassword1">OBS</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" name="pai_obs_numero_celular">
                            </div>
                            <div class="form-group col-md-1">
                                <label for="exampleInputPassword1">Cob.</label>
                                <select id="inputState" class="form-control custom-select" name="pai_cob_num_celular">
                                    <option value="0">Não</option>
                                    <option value="1">Sim</option>
                                </select>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-1">
                                <label for="exampleInputEmail1">DDD </label>
                                <input type="text" class="form-control" id="cep" name="pai_ddd_adicional">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="exampleInputPassword1">Tel. adicional</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" name="pai_tel_adicional">
                            </div>
                            <div class="form-group col-md-5">
                                <label for="exampleInputPassword1">OBS</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" name="pai_obs_numero_adicional">
                            </div>
                            <div class="form-group col-md-1">
                                <label for="exampleInputPassword1">Cob.</label>
                                <select id="inputState" class="form-control custom-select" name="pai_cob_num_adicional">
                                    <option value="0">Não</option>
                                    <option value="1">Sim</option>
                                </select>
                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-1">
                                <label for="exampleInputEmail1">DDD </label>
                                <input type="text" class="form-control" id="cep" name="mae_ddd_celular">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="exampleInputPassword1">Tel. Celular</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" name="mae_tel_celular">
                            </div>
                            <div class="form-group col-md-5">
                                <label for="exampleInputPassword1">OBS</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" name="mae_obs_numero_celular">
                            </div>
                            <div class="form-group col-md-1">
                                <label for="exampleInputPassword1">Cob.</label>
                                <select id="inputState" class="form-control custom-select" name="mae_cob_num_celular">
                                    <option value="0">Não</option>
                                    <option value="1">Sim</option>
                                </select>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-1">
                                <label for="exampleInputEmail1">DDD </label>
                                <input type="text" class="form-control" id="cep" name="mae_ddd_adicional">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="exampleInputPassword1">Tel. adicional</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" name="mae_tel_adicional">
                            </div>
                            <div class="form-group col-md-5">
                                <label for="exampleInputPassword1">OBS</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" name="mae_obs_numero_adicional">
                            </div>
                            <div class="form-group col-md-1">
                                <label for="exampleInputPassword1">Cob.</label>
                                <select id="inputState" class="form-control custom-select" name="mae_cob_num_adicional">
                                    <option value="0">Não</option>
                                    <option value="1">Sim</option>
                                </select>
                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                <label for="exampleInputPassword1">Responsável.</label>
                                <select id="resp_acad" class="form-control custom-select" name="responsavel_financeiro">
                                    <option value="Aluno">Aluno</option>
                                    <option value="Pai">Pai</option>
                                    <option value="Mãe">Mãe</option>
                                    <option value="Outro">Outro</option>
